          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                ...
                low-income households and survivors or those at risk of SGBV.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                OVAH strengthens self-esteem, autonomy, and leadership skills to
                support personal, social, and economic development. Through
                social and behavior change communication and community
                dialogues, we work to challenge harmful norms and shift
                attitudes and behaviors, creating safer, more inclusive
                communities.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-6 shadow-xl border border-border max-w-xs">
              ...
              <p className="text-sm text-muted-foreground">
                Empowering communities across Tanzania through innovative
                programs and survivor-centered approaches.
              </p>
              <Button
                variant="secondary"
                size="sm"
                className="gradient-cta hover:opacity-90 transition-all duration-300 text-white font-semibold px-8 py-4 mt-4 text-lg shadow-lg"
                onClick={() => {
